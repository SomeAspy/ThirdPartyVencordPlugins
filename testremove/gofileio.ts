...
export default definePlugin({
    name: 'Gofileio',
    description:
        'Allow for you to upload files to gofile.io and send them to others',
    authors: [Devs.Samu],
    ...
    commands: [
        {
            name: 'goupload',
            description:
                'Upload a file to gofile.io and adds it to your clipboard',
            ...
            execute: async (args, ctx) => {
                ...
                const upload = UploadStore.getUploads(
                    ctx.channel.id,
                    DRAFT_TYPE,
                )[0];
